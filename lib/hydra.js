(function() {
  var Buffer, CL, CommandQueue, Context, Device, Hydra, Kernel, Mozilla, Nokia, Platform, Program, Provider, Samsung;
  ...
  Context = (function() {
    ...
    Context.prototype.createCommandQueue = function(device, properties) {
      return new CommandQueue(this.id.createCommandQueue(device.id, properties), this);
    };
  ...
  CommandQueue = (function() {
    ...
    function CommandQueue(queue, context) {
    ...
    CommandQueue.prototype.finish = function() {
      ...
      switch (Hydra.provider) {
        case Samsung:
          if ((_ref = this.synchronizeBuffer) == null) {
            this.synchronizeBuffer = this.context.createBuffer(Hydra.MEM_READ_WRITE, 4).id;
          }
          if ((_ref2 = this.synchronizeTarget) == null) {
            this.synchronizeTarget = new Float32Array(1);
          }
          return this.id.enqueueReadBuffer(this.synchronizeBuffer, true, 0, 4, this.synchronizeTarget, 0);
        default:
