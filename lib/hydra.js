(function() {
  var Buffer, CL, Context, Device, Hydra, Kernel, Nokia, Platform, Program, Provider, Samsung;
  ...
  Program = (function() {
    ...
    Program.prototype.buildProgram = function() {
      switch (Hydra.provider) {
        case Samsung:
  ...
  Kernel = (function() {
    ...
    Kernel.prototype.setKernelArgGlobal = function(i, value) {
      switch (Hydra.provider) {
        case Samsung:
          return this.id.setKernelArgGlobal(i, value);
        case Nokia:
          throw "Not implemented yet";
      }
    };
